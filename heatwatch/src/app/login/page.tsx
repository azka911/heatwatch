...
//             Welcome to HeatWatch
//           </h1>
//           <p className="mt-1 text-sm text-slate-500">
//             Urban Heat & Hotspot Dashboard
//           </p>
//         </div>
...
export default function AuthPage() {
  ...
  // ✅ Show a friendly message when redirected from callback
  useEffect(() => {
    if (verified === "1") {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (mode === "signin") {
        ...
        // ✅ After sign-in, ensure profile exists (safe upsert)
        const {
          data: { user },
      ...
      // ✅ Do NOT insert into profiles here (user not truly logged in yet)
